...
- Settings clarity: adds concise help text under each quiz setting, introduces dedicated "insert before/after" and "never insert inside" selectors, switches the minimum-distance control to pixels, disables the placement fields unless auto insertion is enabled, and adds an opt-in console logging toggle for debugging.
